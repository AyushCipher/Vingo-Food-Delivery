...
import { FaUtensils, FaPen, FaPlus, FaVideo } from "react-icons/fa";
        ...
        <div className="w-full flex flex-col gap-6 items-center px-4 sm:px-6 mb-[20px]">
          ...
          <div className="w-full max-w-3xl flex gap-3">
            <button
              ...
              className="flex-1 bg-gradient-to-r from-orange-500 to-red-500 text-white py-4 rounded-xl font-bold text-lg flex items-center justify-center gap-3 shadow-lg hover:shadow-xl transition-all hover:scale-[1.02]"
            >
            ...
            <button
              ...
              className="flex-1 bg-gradient-to-r from-purple-500 to-pink-500 text-white py-4 rounded-xl font-bold text-lg flex items-center justify-center gap-3 shadow-lg hover:shadow-xl transition-all hover:scale-[1.02]"
            >
              <FaVideo className="w-6 h-6" />
              My Reels
            </button>
