...
import FoodReelsFeed from '../components/FoodReelsFeed';
...
function UserHomeTabs() {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col items-center bg-[#fff9f6]">
      {/* TAB NAVIGATION */}
      <div className="w-full max-w-6xl flex gap-4 justify-center mt-6 mb-4 px-4">
        <button
          onClick={() => setActiveTab('home')}
          className={`px-8 py-3 rounded-full font-semibold text-lg transition-all ${
            activeTab === 'home'
              ? 'bg-[#ff4d2d] text-white shadow-lg'
              : 'bg-white text-gray-600 border border-gray-300 hover:border-[#ff4d2d]'
          }`}
        >
          Home
        </button>
        <button
          ...
          className="px-8 py-3 rounded-full font-semibold text-lg transition-all bg-white text-gray-600 border border-gray-300 hover:border-[#ff4d2d] hover:bg-[#ff4d2d] hover:text-white"
        >
          Loops
        </button>
      </div>
